...
if eyetrace.hit then
    ...
    if eyetrace.enthit == thisEntity or class == "hlvr_piano" or name == "russell_entry_window" or class == "item_combine_tank_locker" or vlua.find(name, "socket") or vlua.find(name, "traincar_01") then
        useRoutine = 1
