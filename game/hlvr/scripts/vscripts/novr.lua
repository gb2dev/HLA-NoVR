if GlobalSys:CommandLineCheck("-novr") then
        ...
        if not player:IsUsePressed() then
            ...
            if traceTable.hit then
                ...
                if ent then
                    ...
                    if ent:Attribute_GetIntValue("used", 0) == 0 and not (parent and vlua.find(parent:GetName(), "Console")) and name ~= "traincar_01_hackplug" then
    ...
    player_spawn_ev = ListenToGameEvent('player_activate', function(info)
        ...
        if not loading_save_file and GlobalSys:CommandLineCheck("-noversioninfo") == false then
            ...
            DebugDrawScreenTextLine(5, GlobalSys:CommandLineInt("-h", 15) - 10, 0, "NoVR Version: Nov 21 12:43", 255, 255, 255, 255, 999999)
        end
