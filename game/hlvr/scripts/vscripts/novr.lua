        ...
        if not player:IsUsePressed() then
            ...
            if traceTable.hit then
                ...
                if ent then
                    ...
                    if ent:Attribute_GetIntValue("used", 0) == 0 and not (parent and vlua.find(parent:GetName(), "Console")) and name ~= "traincar_01_hackplug" and ent:GetGraphParameter("b_PlugDisabled") == false then
