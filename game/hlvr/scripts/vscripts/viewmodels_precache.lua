...
function Precache(context)
	...
	PrecacheModel("models/weapons/v_pistol_hopper_no_shroud.vmdl", context)
	PrecacheModel("models/weapons/v_pistol_hopper_no_shroud_stock.vmdl", context)
	PrecacheModel("models/weapons/v_pistol_hopper_no_stock.vmdl", context)
	PrecacheModel("models/weapons/v_pistol_hopper_no_stock_ads.vmdl", context)
	...
	PrecacheModel("models/weapons/v_shotgun_hopper_grenade_attached.vmdl", context)
	PrecacheModel("models/weapons/v_shotgun_hopper_no_burst.vmdl", context)
	PrecacheModel("models/weapons/v_shotgun_hopper_no_burst_grenade_attached.vmdl", context)
	PrecacheModel("models/weapons/v_shotgun_hopper_no_grenade.vmdl", context)
	PrecacheModel("models/weapons/v_shotgun_hopper_no_burst_grenade.vmdl", context)
	...
	PrecacheModel("models/weapons/v_smg1_casing_no_holo.vmdl", context)
	PrecacheModel("models/weapons/v_smg1_casing_no_holo_powerpack.vmdl", context)
